...
#     logger.log(n_epochs=n_epochs, n_updates=n_updates, tr_cost=tr_cost, va_cost=va_cost, tr_acc=tr_f1, va_acc=va_f1)
...
#     parser.add_argument('--n_ctx', type=int, default=27)
